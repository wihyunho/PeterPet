...
<body>
<input type="hidden" class="myLocation" id="myLocation">
<button id="categoryhidden" onclick="return false;" style="margin-bottom: 10px; margin-left: 10px;" class="button">카테고리 접기/펼치기</button>
<div class="map_wrap">
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=357f5f65e8c6ffad49f02e604361771b&libraries=services"></script>
<script>
	...
	function displayMarker(locPosition) {
		...
		//내위치 마커가 드래그 가능하도록 설정합니다 
		mylocation.setDraggable(true); 
		
		document.getElementById('myLocation').value = mylocation.getPosition();
		
		// 마우스를 마커에 올릴 시 인포윈도우 삭제
		kakao.maps.event.addListener(mylocation, 'mouseover', function() {
			myinfo.close();
		});
	
		 // 마우스를 내위치 마커에 올릴 시 인포윈도우 삭제
        ...
        kakao.maps.event.addListener(mylocation, 'dragend', function() {
        	document.getElementById('myLocation').value = mylocation.getPosition();
        });
		
		myinfo.open(map, mylocation);
	}
	...
	function getListItem(index, places) {
	    ...
	    +'<div class="info">' 
	    +'<a href="'+naverSearch(places.place_name)+' " target="_blank">'

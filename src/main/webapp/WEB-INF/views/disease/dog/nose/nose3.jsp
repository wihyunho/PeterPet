				...
				<ul class="grid">
					...
					<li class="grid-12"><dl class="search-category-list">
							...
							<dd onclick="A();" class="name">
								<label>
									<span>새끼이고 열이나 기침, 눈곱 등을 동반한다</span>
								</label>
							</dd>
						</dl>
					</li>
					...
					<li class="grid-12"><dl class="search-category-list">
							...
							<dd onclick="B();" class="name">
								<label>
									<span>물 같은 콧물이 나온다</span>
								</label>
							</dd>
							<dd onclick="B();" class="name">
								<label>
									<span>콧물에 피가 섞여 있다</span>
								</label>
							</dd>
							<dd onclick="B();" class="name">
								<label>
									<span>마르고 심한 기침이 나온다</span>
								</label>
							</dd>
							<dd onclick="B();" class="name">
								<label>
									<span>가래가 껴서 토하거나 미열이 난다</span>
								</label>
							</dd>
						</dl>
					</li>

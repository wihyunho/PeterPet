		...
		<script type="text/javascript">
			...
			<li class="grid-12"><dl class="search-category-list">
				...
				function B() {
					...
					document.getElementById("imgId").src = "resources/images/disease/dog/bronchial/bronchial_1.jpg";
			...
			<script type="text/javascript">
				function C() {
					...
					document.getElementById("imgId").src = "resources/images/disease/dog/bronchial/bronchial_2.jpg";
			...
			<script type="text/javascript">
				function D() {
					...
					document.getElementById("imgId").src = "resources/images/disease/dog/bronchial/bronchial_3.jpg";
			...
			<script type="text/javascript">
				function F() {
					...
					document.getElementById("imgId").src = "resources/images/disease/dog/bronchial/bronchial_4.jpg";
			...
			<script type="text/javascript">
				function G() {
					...
					document.getElementById("imgId").src = "resources/images/disease/dog/bronchial/bronchial_5.jpg";

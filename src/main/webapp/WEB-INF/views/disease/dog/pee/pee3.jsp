...
<head>
<meta charset="UTF-8">
<title>소변이 나오지 않는다, 보기 힘들어 한다</title>
				...
				<ul class="grid">
					...
					<li class="grid-12"><dl class="search-category-list">
							...
							<dd onclick="A();" class="name">
								<label><span>꼬박 하루 동안 나오지 않는다</span></label>
							</dd>
							<dd onclick="A();" class="name">
								<label><span>녹초가 된다</span></label>
							</dd>
							<dd onclick="A();" class="name">
							...
							<dd onclick="A();" class="name">
								<label><span>다음, 다뇨 등의 증상을 보이다가 소변량이 적어지고, 어느 순간 나오지 않는다</span></label>
							</dd>
							<dd onclick="A();" class="name">
					...
					<li class="grid-12"><dl class="search-category-list">
							...
							<dd onclick="D();" class="name">
								<label><span>변비가 일어나거나, 변이 얇아진다</span></label>
							</dd>
							<dd onclick="D();" class="name">
								<label><span>혈뇨가 나온다</span></label>
							</dd>
						</dl></li>
					<script type="text/javascript">
						function E() {
					...
					<li class="grid-12"><dl class="search-category-list">
							...
							<dd onclick="E();" class="name">
								<label><span>항문 한쪽 또는 양쪽이 크게 부풀어 오른다</span></label>
							</dd>
						</dl></li>
					<script type="text/javascript">
						function F() {
					...
					<li class="grid-12"><dl class="search-category-list">
							...
							<dd onclick="G();" class="name">
								<label><span>기운이 있고 식욕이 있다</span></label>
							</dd>
							<dd onclick="G();" class="name">
								<label><span>소변의 색이 탁하다, 진하다</span></label>
							</dd>
							<dd onclick="G();" class="name">
								<label><span>소변의 냄새가 강하게 난다</span></label>
							</dd>
							<dd onclick="G();" class="name">
